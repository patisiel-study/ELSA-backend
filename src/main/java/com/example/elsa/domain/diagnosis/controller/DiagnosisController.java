...
public class DiagnosisController {
    ...
    public ResponseEntity<ResponseDto<?>> submitNonMemberDiagnosisResult(@RequestBody NonMemberDiagnosisSubmitRequest request) {
        return ResponseEntity.ok(new ResponseDto<>("비회원의 자가진단 결과를 성공적으로 제출 완료했습니다.", diagnosisService.nonMemberSubmitDiagnosisResult(request)));
    }
